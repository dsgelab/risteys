defmodule Risteys.MortalityStats do
  ...
  def changeset(mortality_stats, attrs) do
    mortality_stats
    |> cast(attrs, [:fg_endpoint_id, :lagged_hr_cut_year, :hr, :hr_ci_min, :hr_ci_max, :pvalue, :n_individuals, :absolute_risk])
    |> validate_required([:fg_endpoint_id, :lagged_hr_cut_year, :hr, :hr_ci_min, :hr_ci_max, :pvalue, :n_individuals, :absolute_risk])
    ...
    |> unique_constraint(:fg_endpoint_id, name: :fg_endpoint_hrlag)
  end
end
