...
* [[file-corr-pheno-geno]]FinnGen phenotypic + genotypic correlations
** name: `corr_pheno-fg-r12.0_geno-fg-r11.0_full-join__2023-10-12__XXH64_751e7e7471ae1e0d.csv.zst`
...
** name: `r11.autoreport.compare.keep_cs.r2_0.8.pval_5e_8.variants__XXH64_7c339268fa9d4fd0.csv`
...
* [[file-gen-correlations]] FinnGen genetic correlations
** name: `finngen_R11_FIN.ldsc.summary__XXH64_ccf413bdd1d356d7.tsv`
