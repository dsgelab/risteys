defmodule Risteys.Icd10Test do
  ...
  describe "Symptom / Cause pairs" do
    ...
    test "& ➝ *: G590&E104|G590&E114", context do
      # From DM_MONONEURO
    ...
    test "& ➝ * :  M07&L405|M07[1-3]", context do
    ...
    test "non-matching: F009&G309", context do
      # From AD_U
      #
  ...
  describe "Mode endpoints" do
    test "%J300", context do
